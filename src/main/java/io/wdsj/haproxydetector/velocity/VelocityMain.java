package io.wdsj.haproxydetector.velocity;
...
@Plugin(id = "haproxy-detector", name = "HAProxyDetector", version = "3.2.0",
    url = "https://github.com/HaHaWTH/haproxy-detector",
...
public final class VelocityMain {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) throws ReflectiveOperationException, IOException {
        ...
        try {
            Metrics metrics = metricsFactory.make(this, 21070);
